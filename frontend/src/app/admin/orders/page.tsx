        ...
        <aside className="w-64 bg-white shadow-lg min-h-screen">
          <div className="p-6">
            ...
            <nav className="space-y-2">
              ...
              <button onClick={() => router.push('/admin/orders')} className="w-full text-left px-4 py-3 bg-red-50 text-red-600 rounded-lg font-medium flex items-center gap-3">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-center py-12">
              <svg className="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
