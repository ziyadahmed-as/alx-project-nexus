    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(blank=True, db_index=True, help_text="Official name of the vendor's company", max_length=255, null=True, unique=True, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z0-9\\s,.&-]+$')])),
        ...
        migrations.AddIndex(
            model_name='vendor',
            index=models.Index(fields=['business_type', 'verification_status'], name='vendor_type_status_idx'),
        ),
        migrations.AddIndex(
            model_name='vendor',
            index=models.Index(fields=['company_registration_number'], name='vendor_reg_num_idx'),
        ),
        migrations.AddIndex(
            model_name='vendor',
            index=models.Index(fields=['business_email'], name='vendor_business_email_idx'),
        ),
        migrations.AddConstraint(
            model_name='vendor',
            constraint=models.UniqueConstraint(fields=('tax_identification_number',), name='unique_vendor_tax_id'),
        ),
        migrations.AddConstraint(
            model_name='vendor',
            constraint=models.UniqueConstraint(fields=('business_email',), name='unique_vendor_business_email'),
        ),
        migrations.AddIndex(
            model_name='user',
